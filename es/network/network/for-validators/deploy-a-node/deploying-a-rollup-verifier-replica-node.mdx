...
<Tabs>
  ...
  <Tab title="Ejecutando el nodo desde el binario">
    ...
    <Info>
      ...
      3. Si la velocidad de sincronización es lenta, intente cambiar su URL de DTL, puede ver más detalles [aquí](/es/network/network/for-validators/deploy-a-node/deploying-a-rollup-verifier-replica-node#network-dtl-url).
    </Info>
