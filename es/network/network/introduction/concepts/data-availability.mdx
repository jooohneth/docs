...
- description: Desbloqueando disponibilidad de datos hiper-escalada en un rollup de Capa 2
---
...
Esto explica por qué las blockchains usan criptografía. En lugar de confiar en acuerdos suaves y contratos sociales con otros participantes de la red (es decir, confianza), las blockchains utilizan reglas duras y código para hacer cumplir el comportamiento esperado. Lo que esto significa en la práctica es que las blockchains están diseñadas para que cualquier usuario pueda verificar si un participante de la red ha seguido las reglas.
...
Al igual que los rollups optimistas utilizan incentivos económicos para mantener la integridad del sistema, este mecanismo también establece incentivos para que los validadores de Ethereum proporcionen sus servicios para oportunidades de rendimiento adicionales. Lee más sobre EigenLayer [here](https://ethresear.ch/t/an-eigenlayer-centric-roadmap-or-cancel-sharding/14141#what-is-eigenlayer-1).
...
Ten en cuenta que: **Mantle DA**, permite que los nodos con permiso proporcionen servicios de disponibilidad de datos a la red Mantle y requiere staking de \$MNT.
...
* Permite**desacoplamiento**de la**capa de disponibilidad de datos**de la**capa de consenso**
...
* Mantener una**tasa de borrado**asegura que las piezas de datos de bloque de fuentes L2 y L1 puedan ser utilizadas por actores verificadores para reconstruir datos de bloque completos

Este enfoque proporcionará el**alto rendimiento**y**bajo costo de gas**necesario para las aplicaciones de próxima generación en juegos blockchain, redes sociales descentralizadas y más.
