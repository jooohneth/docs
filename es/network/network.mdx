...
<Info>
  ...
  Por otro lado, si estos términos le emocionan por el futuro del escalado de blockchain, ¡le animamos a seguir leyendo!
</Info>
...
El secuenciador centralizado en Mantle Network produce bloques L2 incluyendo transacciones en ellos en el orden en que son recibidas por los nodos. También publica raíces de estado actualizadas en L1.
...
La disponibilidad de datos (de los datos de lotes de L2) es un aspecto crítico de los rollups de Ethereum, de modo que los validadores de L1 puedan verificar el estado de L2. DA es generalmente el componente más costoso de los rollups, ya que requiere espacio en los bloques de Ethereum L1. Los enfoques comunes de la industria para la disponibilidad de datos incluyen:
