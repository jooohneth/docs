...
Este diagrama ilustra cómo los diferentes módulos y componentes de la red interactúan a través de la ejecución de transacciones en Mantle v2 Tectonic. Representa el proceso de interacción con la Disponibilidad de Datos de Mantle (DA) soportada por EigenDA para almacenar datos de Rollup y eventualmente publicar datos de estado actualizados en el L1 de Ethereum.
