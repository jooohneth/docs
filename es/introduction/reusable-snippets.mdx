...
1. Añade contenido a tu archivo de fragmento que quieras reutilizar en múltiples ubicaciones. Opcionalmente, puedes añadir variables que se pueden rellenar a través de props cuando importes el fragmento.
